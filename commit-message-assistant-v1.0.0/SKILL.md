...
description: "Use when user asks for commit messages / 提交备注 / 帮我写提交信息 / 这些改动怎么写提交. Read-only: collects uncommitted changes via diff/ls-files, generates paste-ready Conventional Commits per file. Never commits or pushes. Not for git Q&A or PR descriptions."
---
